...
public class FFT
{
	...
	/**
	 * We will here precalculate all sin and cos values and all other things we
	 * can store
	 * 
	 * @since 03.10.2007
	 */
	...
	/**
	 * The main routine. We expect sampledata with 1.0<=x<=-1.0 The return value
	 * (magnitude) will be in the same spectrum.
	 * 
	 * @since 03.10.2007
	 * @param pSample
	 * @return
