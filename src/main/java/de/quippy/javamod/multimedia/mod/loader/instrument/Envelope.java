...
public class Envelope
{
	...
	/**
	 * Sets the boolean values corresponding to the flag value IT-Version (why
	 * on earth needed this to be swaped?!)
	 * 
	 * @since 12.11.2006
	 * @param flag
	 */
	...
	/**
	 * @param loopStartPoint
	 *            The loopStartPoint to set.
	 */
	...
	/**
	 * @param sustainPoint
	 *            The sustainPoint to set. (XM-Version)
	 */
	...
	/**
	 * @param sustainEndPoint
	 *            the sustainEndPoint to set (IT-Version)
	 */
	...
	/**
	 * @param sustainStartPoint
	 *            the sustainStartPoint to set (IT-Version)
	 */
