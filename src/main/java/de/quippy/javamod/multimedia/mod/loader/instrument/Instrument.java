...
public class Instrument
{
	...
	/**
	 * @param dublicateNoteCheck
	 *            the dublicateNoteCheck to set
	 */
	...
	/**
	 * @param dublicateNodeAction
	 *            the dublicateNodeAction to set
	 */
	...
	/**
	 * @param pitchPanSeparation
	 *            the pitchPanSeparation to set
	 */
	...
	/**
	 * @param pitchPanCenter
	 *            the pitchPanCenter to set
	 */
	...
	/**
	 * @param randomVolumeVariation
	 *            the randomVolumeVariation to set
	 */
	...
	/**
	 * @param randomPanningVariation
	 *            the randomPanningVariation to set
	 */
	...
	/**
	 * @param initialFilterCutoff
	 *            the initialFilterCutoff to set
	 */
	...
	/**
	 * @param initialFilterResonance
	 *            the initialFilterResonance to set
	 */
